...
include("./includes/classes/Applicant.php");
include("./includes/classes/Resume.php");
include("./includes/classes/ApplicantResume.php");
include("./includes/classes/Constants.php");
$enterpriceAccount = new EnterpriseAccount($con);
$applicant = new Applicant($con);
$resume = new Resume($con);
